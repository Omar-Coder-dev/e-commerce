...
import { WishlistProduct } from 'images/types/wishlist.type'
                ...
                <Link href={`/products/${product._id}`} className="block cursor-pointer">
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center gap-2 mb-4">
                      ...
                      <span className="text-sm text-gray-600 font-medium">{product.ratingsAverage || 0}</span>
                      <span className="text-xs text-gray-400">({product.ratingsQuantity || 0})</span>
                    </div>

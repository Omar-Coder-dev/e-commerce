// To parse this data:
//
//   import { Convert, ProductDetails } from "./file";
//
//   const productDetails = Convert.toProductDetails(json);
//
...
export class Convert {
    public static toProductDetails(json: string): ProductDetails {
        return cast(JSON.parse(json), r("ProductDetails"));
    }

    public static productDetailsToJson(value: ProductDetails): string {
        return JSON.stringify(uncast(value, r("ProductDetails")), null, 2);
    }
}
